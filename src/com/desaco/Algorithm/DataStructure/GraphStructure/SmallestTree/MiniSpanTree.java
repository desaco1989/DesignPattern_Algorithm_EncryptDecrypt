...
/**
 * 图的最小树生成算法 http://blog.csdn.net/jianfpeng241241/article/details/50452680
 * 
 * MiniSpanTree中两个静态函数实现了最小生成树的Prim算法和Kruskal算法：
 *  普利姆算法(prime)、克鲁斯卡尔算法(Kruskal)
 * 
 * @author desaco
 *
 */
public class MiniSpanTree {
	 ...
	 *            图中节点数
	 */
	public static void prime(int[][] graph, int start, int n) {
	...
	public static void main(String[] args) {
		int[][] tree = { { -1, 6, 1, 5, -1, -1 }, { 6, -1, 5, -1, 3, -1 }, { 1, 5, -1, 5, 6, 4 },
				{ 5, -1, 5, -1, -1, 2 }, { -1, 3, 6, -1, -1, 6 }, { -1, -1, 4, 2, 6, -1 } };
		MiniSpanTree.prime(tree, 0, 6);
		System.out.println("+++++++++++++++++++++++++++++++++");
