...
/**
 * 线性约束规划问题- http://www.cnblogs.com/cndavy/p/5462554.html
 * 线性规划 (Linear Programming，简称LP) 问题是目标函数和约束条件都是线性的最优化问题。 
 * 百度定位，行程路线规划 线性规划
 * 
 * model:
 * max=13*A+ 23*B;
 ...
 * end
 * 
 * @author desaco Create by 2017.03.20
 */
public class LinearProgrammingAlgorithm {
	...
	public LinearProgrammingAlgorithm(double[][] A, double[] b, double[] c) {
		M = b.length;
		N = c.length;
	...
	public static void test(double[][] A, double[] b, double[] c) {
		LinearProgrammingAlgorithm lp = new LinearProgrammingAlgorithm(A, b, c);
